(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["mangoPluginLog"] = factory();
	else
		root["mangoPluginLog"] = factory();
...
var _mangoPluginPopup = __webpack_require__(4);
...
(0, _mangoHelper.setLocalStorage)('_chimee_t', pageLoadedTimestamp);
var supportLS = (0, _mangoHelper.getLocalStorage)('_chimee_t') === pageLoadedTimestamp;
// 为日志相关事件实现基本的日志输出绑定
    ...
    evs.forEach(function (evType) {
        rets[evType] = function (e) {
            ...
            var _a = this,
                ...
                src = _a.src;
            var _b = this,
                waitingNum = _b._waiting_num,
                currentTime = _b.currentTime,
                _c = _b._is_seek,
                isSeek = _c === void 0 ? false : _c,
                _d = _b._is_play,
                isPlay = _d === void 0 ? false : _d,
                playingTimestamp = _b.playingTimestamp,
                loadstartTimestamp = _b.loadstartTimestamp,
                waitingTimestamp = _b.waitingTimestamp;
            switch (evType) {
                case 'loadstart':
...
exports.default = (0, _mangoPluginPopup2.default)({
    name: 'chimeeLog',
    ...
    hide: true,
    autoFocus: false,
    logPostUrl: undefined,
    beforeCreate: function beforeCreate(_, option) {
        if ((0, _mangoHelper.isUrl)(option.logPostUrl)) {
    ...
    create: function create() {
        ...
        if (supportLS) {
            var lsKey_1 = 'auto_on';
            // 下次自动打开日志展示窗口
            var autoOn = (0, _mangoHelper.getLocalStorage)(lsKey_1) === '1';
            $wrap.find('input[type="checkbox"]').on('change', function (e) {
                (0, _mangoHelper.setLocalStorage)(lsKey_1, +this.checked);
            })[0].checked = autoOn;
            // 告诉父组件是否create后开启
            this._hide = !autoOn;
        }
    ...
    methods: {
        writeLog: function writeLog(event) {
            ...
            var logText = this.$txtEl.text() + "\n[" + (0, _mangoHelper.formatDate)(new Date(this[logName + 'Timestamp']), 'yyyy-MM-dd hh:mm:ss.i') + "] " + logName + " " + (logData !== undefined ? JSON.stringify(logData) : '');
        ...
        sendLog: function sendLog(logType, data) {
            ...
            var logData = (0, _mangoHelper.deepAssign)(data || {}, this.logBase);
            var logParseFunName = "send_" + logType + "_log";
            if (this[logParseFunName]) {
                (0, _mangoHelper.deepAssign)(logData, this[logParseFunName](logType, logData));
            }
            (0, _mangoHelper.deepAssign)(logData, {
                evt: logType,
                _t: +new Date(),
                _r: Math.random()
            });
    ...
    events: (0, _mangoHelper.deepAssign)(defaultEvents, {
    ...
    data: {
        ...
        logBase: {
            uid: function (uid) {
                if (!uid) {
                    uid = (0, _mangoHelper.uuid)();
                    (0, _mangoHelper.setLocalStorage)('_chimee_uid', uid);
                }
                return uid;
            }((0, _mangoHelper.getLocalStorage)('_chimee_uid')),
            ref: location.href
        }
    },
    computed: {
...
// module
exports.push([module.i, ".chimee-log {\n  position: absolute;\n  padding: 2px;\n  box-shadow: 0 1px 4px rgba(0, 0, 0, 0.6);\n}\n.chimee-log label {\n  margin-left: 10px;\n  font-weight: 100;\n  font-size: 12px;\n}\n.chimee-log label input {\n  vertical-align: middle;\n  display: inline;\n  width: auto;\n  padding: 0;\n  margin: 0;\n}\n.chimee-log vs-pp-body {\n  padding: 3px;\n}\n.chimee-log textarea {\n  display: block;\n  width: 100%;\n  height: 200px;\n  margin: -3px;\n  border: 1px solid rgba(255, 255, 255, 0.5);\n  background-color: rgba(255, 255, 255, 0.9);\n}\n", ""]);
