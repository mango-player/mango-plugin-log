...
(0, _mangoHelper.setLocalStorage)('_mango_t', pageLoadedTimestamp);
var supportLS = (0, _mangoHelper.getLocalStorage)('_mango_t') === pageLoadedTimestamp;
// 为日志相关事件实现基本的日志输出绑定
        ...
        logBase: {
            uid: function (uid) {
                if (!uid) {
                    ...
                    (0, _mangoHelper.setLocalStorage)('_mango_uid', uid);
                }
                return uid;
            }((0, _mangoHelper.getLocalStorage)('_mango_uid')),
            ref: location.href
        }
    },
    computed: {
...
// module
exports.push([module.i, ".mango-log {\n  position: absolute;\n  padding: 2px;\n  box-shadow: 0 1px 4px rgba(0, 0, 0, 0.6);\n}\n.mango-log label {\n  margin-left: 10px;\n  font-weight: 100;\n  font-size: 12px;\n}\n.mango-log label input {\n  vertical-align: middle;\n  display: inline;\n  width: auto;\n  padding: 0;\n  margin: 0;\n}\n.mango-log vs-pp-body {\n  padding: 3px;\n}\n.mango-log textarea {\n  display: block;\n  width: 100%;\n  height: 200px;\n  margin: -3px;\n  border: 1px solid rgba(255, 255, 255, 0.5);\n  background-color: rgba(255, 255, 255, 0.9);\n}\n", ""]);
